    ...
    public static void main(String[] args) {
        ...
        while( init != 0) {
           ...
           System.out.println("Seleccione 1. para crear un usuario" + "\n" +
                    ...
                    "Seleccione 4 validar categoria de salario" + "\n" +
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    if (salarioNeto <= 2600000 ) {
                        System.out.println("El salario es de tipo A");
                    } else if (salarioNeto >= 2600000 && salarioNeto <= 5200000){
                    ...
                    break;
                case 5:
                    System.out.println( "usuario " + userCreated + "\n" +
                                    "correo " + correoCreated + "\n" +
